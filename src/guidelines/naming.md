...
Naming things is hard. We want to validate each choice and find better alternatives if possible.

## Why

Introducing new concepts to codebase is a very important part of software development - very often concepts will stick.
Things named badly will impact communication, understanding and slow down the development process. We want to avoid that.

It's really hard to unwind wrong names, so we want to catch them as early as possible. It's also important to stick to stuff
that is already used in the codebase - new concepts shouldn't be introduced without a good reason.

## Guidelines for naming

### Avoid naming if possible

Not everything needs a name. We have e.g. anonymous functions or statements -
use them if they make the code more readable. Naming introduces cognitive load.
...
Pick **one** naming convention and follow it. Look at the project and find out which one is used. It may be `camelCase`, `PascalCase`, `snake_case`, or anything else, as long as it remains consistent.
